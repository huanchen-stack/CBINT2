...
def _process_shards(
    ...
    for shard_idx, shard_rel in enumerate(shard_order, start=1):
        ...
        for base in shard_targets:
            ...
            print(f"  [{idx}/{len(target_layers)}] fakequant {base}")
...
def run(input_path: Path, output_path: Path, device: str, mlp_only: bool, dry_run: bool) -> None:
...
def main() -> None:
    ...
    default_input = "models/Qwen2.5-VL-7B-Instruct-NVFP4"
